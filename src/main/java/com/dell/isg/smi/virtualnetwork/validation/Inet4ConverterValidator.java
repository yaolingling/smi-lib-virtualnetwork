...
public final class Inet4ConverterValidator {
    ...
    public static long convertIpStringToLong(String address) {
        if (!StringUtils.hasLength(address)) {
            ...
            BusinessValidationException bve = new BusinessValidationException(ErrorCodeEnum.INVALID_IPADDRESS_CODE);
        ...
        for (String part : parts) {
            try {
                ...
                throw new BusinessValidationException(ErrorCodeEnum.ENUM_INVALIDINPUT_ERROR);
            }
        }
        return result;
    }
