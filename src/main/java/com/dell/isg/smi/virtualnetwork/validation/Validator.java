...
public class Validator {
    ...
    public static void validateDescription(String description) {
        ...
        if (!isDescriptionLengthValid) {
            throw new BusinessValidationException(ErrorCodeEnum.INVALID_DESC_LENGTH_CODE);
        }
        if (!isDescriptionValid) {
            throw new BusinessValidationException(ErrorCodeEnum.INVALID_DESC_FORMAT_CODE);
        }
    }
    ...
    public static void validateName(String name) {
        ...
        if (!isNameLengthValid) {
            BusinessValidationException businessValidationException = new BusinessValidationException(ErrorCodeEnum.INVALID_NAME_LENGTH_CODE);
            businessValidationException.addAttribute(name);
            throw businessValidationException;
        } else if (!isNameValid) {
            BusinessValidationException businessValidationException = new BusinessValidationException(ErrorCodeEnum.INVALID_NAME_FORMAT_CODE);
            businessValidationException.addAttribute(name);
            throw businessValidationException;
        }
    }
    ...
    public static void validateDisplayName(String displayName) {
        ...
        // Throw corresponding exceptions based on the error encountered.
        if (!isNameLengthValid) {
            BusinessValidationException businessValidationException = new BusinessValidationException(ErrorCodeEnum.INVALID_DISPLAY_NAME_LENGTH_CODE);
            businessValidationException.addAttribute(displayName);
            throw businessValidationException;
        } else if (!isNameValid) {
            BusinessValidationException businessValidationException = new BusinessValidationException(ErrorCodeEnum.INVALID_DISPLAY_NAME_FORMAT_CODE);
            businessValidationException.addAttribute(displayName);
            throw businessValidationException;
        }
    }
